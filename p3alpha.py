...
# https://github.com/MaurizioFD/RecSys2019_DeepLearning_Evaluation/blob/master/GraphBased/P3alphaRecommender.py
from scipy import sparse
from sklearn.preprocessing import normalize
import numpy as np 

class P3alpha():
	def __init__(self, train_inter_matrix, test_inter_matrix, alpha=1.0, K=100):
	...
	def generate_pui(self):
   	...
   	def generate_P3(self):
        ...
        self.P3 = sparse.csr_matrix((values[:numCells], (rows[:numCells], cols[:numCells])), shape=(self.Pui.shape[1], self.Pui.shape[1]))
        self.P3 = normalize(self.P3, norm='l1', axis=1)
    ...
    def predict(self, user):
		ranking = list(np.argsort(self.P3[user])[::-1])[:K]
		return ranking 
